...
public sealed class FieldCorrectionDto { public required long Id { get; init; } public required long AuditEventId { get; init; } public required InvoiceFieldKey Field { get; init; } public required string? PreviousValue { get; init; } public required string? NewValue { get; init; } public required int DraftVersion { get; init; } public required DateTimeOffset OccurredAt { get; init; } }
