...
public sealed class EfInvoiceRejectionPersistence(
    InvoiceDbContext context,
    EfInvoiceRepository repository) : IInvoiceRejectionPersistence
{
    public async Task<InvoiceRejectionPersistenceResult> RejectAsync(
        Invoice invoice,
        AuditEvent audit,
        CancellationToken cancellationToken)
    {
        ...
        context.AuditEvents.Add(new AuditEventEntity
        {
            ...
            EventType = nameof(AuditEventType.InvoiceRejected),
        ...
        catch (DbUpdateConcurrencyException)
        {
            ...
            return new InvoiceRejectionPersistenceResult.VersionConflict(new DraftVersion(currentVersion));
        }
        ...
        return new InvoiceRejectionPersistenceResult.Rejected(corrections.Select(ToDomain).ToArray());
    }
